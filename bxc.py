...
def parse_args():
    ...
    parser.add_argument('-O', dest='INPUT_ORDER', type=str, help='Order of input Alphabet e.g.'
                        '"0aA" results in 0..9a..zA..Z')
    parser.add_argument('-o', dest='OUTPUT_ORDER', type=str, help='Order of output Alphabet e.g.'
                        '"0aA" results in 0..9a..zA..Z')
    parser.add_argument('-A', dest='INPUT_ALPHABET', type=str, help='Alternative input alphabet'
                        ' (Will override -O)')
    parser.add_argument('-a', dest='OUTPUT_ALPHABET', type=str, help='Altvernative output '
                        'alphabet (Will override -o)')
    parser.add_argument('-P', dest='INPUT_ALPHABET_APPEND', type=str, help='Append characters '
                        'to input alphabet')
    parser.add_argument('-p', dest='OUTPUT_ALPHABET_APPEND', type=str, help='Append characters '
                        'to output alphabet')
